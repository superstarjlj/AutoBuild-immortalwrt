...
##it_sparse_clone master https://github.com/kiddin9/openwrt-packages luci-app-aliddns
...
# 修改默认IP
sed -i 's/192.168.1.1/192.168.18.26/g' package/base-files/files/bin/config_generate
